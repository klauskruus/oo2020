/*
  ...
  (10-6,5)*2=7 N*m
   kuna 17,5>7
    x=(6,5+3)/2 = 4,5
    arvutan jأµumomendid
    jأ¤tkan, kuni kahe jأµumomendi vahe on vأ¤iksem kui 0.01 N*m
*/

public class PunktmassiPaar implements Punktmass1{
    Punktmass1 p1, p2;
    public PunktmassiPaar(Punktmass1 up1, Punktmass1 up2){
        p1=up1; p2=up2;
    }
    ...
    public String tekstina(){
        return p1.tekstina()+" "+massikeseX()+" "+kysiKg()+" kg"+
               p2.tekstina();
    }
